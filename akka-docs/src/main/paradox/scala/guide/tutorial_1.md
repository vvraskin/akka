...
The *[Actor Lifecycle](http://doc.akka.io/docs/akka/current/scala/actors.html#Actor_Lifecycle)* section of the Akka reference manual provides details on the full set of lifecyle hooks.
